...
class NotificationHandler {
  ...
  static void showNotification(Map<String, dynamic> message) async {
    ...
    var mesajStyle =
        MessagingStyleInformation(mesaj, messages: [Message(message["data"]["message"], DateTime.now(), mesaj)]);
          ...
          builder: (context) => ChangeNotifierProvider(
            builder: (context) => ChatViewModel(
                ...
                sohbetEdilenUser: User.idveResim(
                    userID: gelenBildirim["data"]["gonderenUserID"], profilURL: gelenBildirim["data"]["profilURL"])),
            child: SohbetPage(),
          ),
        ),
      );
