...
class Weather {
  ...
  factory Weather.fromJson(Map<String, dynamic> json) => Weather(
        consolidatedWeather: json["consolidated_weather"] == null
            ? null
            : List<ConsolidatedWeather>.from(json["consolidated_weather"].map((x) => ConsolidatedWeather.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        "consolidated_weather":
            consolidatedWeather == null ? null : List<dynamic>.from(consolidatedWeather.map((x) => x.toJson())),
