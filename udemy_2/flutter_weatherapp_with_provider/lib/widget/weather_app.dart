...
class _HavaDurumuGeldiState extends State<HavaDurumuGeldi> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      var kisaltma = Provider.of<WeatherViewModel>(context).havaDurumuKisaltmasi();
      ...
      child: RefreshIndicator(
        ...
        child: ListView(
          children: <Widget>[
            ...
            Padding(
              padding: const EdgeInsets.all(16.0), //getirilen hava durumunu parametre olarak geçtik
              child: Center(
                  child: MaxveMinSicaklikWidget(
                bugununDegerleri: _weatherViewModel.getirilenWeather.consolidatedWeather[0],
              )),
            ),
          ],
        ),
